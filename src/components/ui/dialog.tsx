...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-40 bg-black/40 brightness-75 data-[state=open]:animate-in data-[state=closed]:animate-out " +
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed font-geometria left-[50%] top-[50%] z-40 grid " +
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      " 320:text-3xl 768:text-4xl font-normal text-center leading-none pb-20px tracking-tight",
      className
    )}
    {...props}
  />
